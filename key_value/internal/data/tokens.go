...
const (
	...
	ScopeAuthentication = "authentication" // A new scope for authenication
)
...
func ValidateTokenPlaintext(v *validator.Validator, tokenPlaintext string) {
	v.Check(tokenPlaintext == "", "token", "mustt be provided")
...
// Insert() ads the data for a specific token to te tokens table
...
func (m TokenModel) Insert(token *Token) error {
	...
	if err != nil {
		fmt.Println("checkkk here token line 115")
	}
	return err
}
